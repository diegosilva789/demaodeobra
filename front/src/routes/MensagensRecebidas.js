              ...
              >
                {total.length === 0 &&
                  <Row className="justify-content-center text-center p-0 m-0 pt-5 pb-5" >
                    <h5>Você ainda não recebeu perguntas</h5>
                  </Row>
                }
                    ...
                    <Row className="justify-content-center">
                      <Row className=" p-3 ms-3 m3-3">
                        <Row style={{ fontSize: "0.7rem" }}>
                          <div className="p-0">
                            <b>Enviada por {item.usu_nome}</b> há {tratarData(item.men_enviada_data)}
                          </div>
                        </Row>
                        ...
                        {item.men_resposta_data &&
                          <Row style={{ fontSize: "0.7rem", textAlign: "end" }}>
                            <div className="p-0">
                              <b>Respondida por Você</b> há {tratarData(item.men_resposta_data)}
                            </div>
                          </Row>
                        }
